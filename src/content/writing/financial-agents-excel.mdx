...
description: >-
  Microsoft owns the file format, the app, frontier model access, and more Excel
  telemetry than anyone alive — and still lost to better-designed Excel agents.
  Two lessons: opinionated tool architecture, and compound expertise.
pubDate: 2026-07-28
tags:
  - AI agents
  - agent design
