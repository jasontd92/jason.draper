...
[Punchcard](https://punchcard.com) is a platform ingesting and checking thousands of documents every day in live financial audits, with both a large breadth of features and complexity to maintain. The constraints as the platform relentlessly grew were very real: [Nathan Turnbow](https://www.linkedin.com/in/turnbow/) and I had a team 1–5% the size of the incumbents, in an industry where reliability meant everything, while also seeking to spend every minute with customers working on novel problems and keeping a lead on innovation in our space.

It didn't take long for the idea of an internal engineering agent to germinate, sprout, and take hold. This was before the "factory" term was coined, though it certainly fit that problem shape.
...
To stay unsupervised and long-running (meaning, weeks to months without intervention), it needed both the right incentives and no way to game them (the way frontier models sometimes [reward-hack their evals](https://openai.com/index/hugging-face-incident-and-the-road-ahead/)). An easy gaming example: give it "drive reported bugs to zero" and it's not out of the question that it authors its own softball tests that don't actually surface bugs, or worse, deletes whole features in the interest of stability ([Tron Legacy](https://en.wikipedia.org/wiki/Tron:_Legacy) has a whole movie plot around this).
...
These roles in aggregate are mutually exclusive, collectively exhaustive, and balanced to ensure that both progress and sustainability are maximized equally.
